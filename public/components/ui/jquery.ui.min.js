...
d.ui.plugin.add("draggable","scroll",{
    ...
    drag:function(a){
        ...
        if(b.scrollParent[0]!=document&&b.scrollParent[0].tagName!="HTML"){
            if(!c.axis||c.axis!=
                "x")if(b.overflowOffset.top+b.scrollParent[0].offsetHeight-a.pageY<c.scrollSensitivity)b.scrollParent[0].scrollTop=f=b.scrollParent[0].scrollTop+c.scrollSpeed;
...
_createButtons:function(a){
    var b=this,d=false,e=c("<div></div>").addClass("ui-dialog-buttonpane ui-helper-clearfix"),g=c("<div></div>").addClass("ui-dialog-buttonset").appendTo(e);
    ...
    if(d){
        c.each(a,function(f,h){
            ...
            var i=c('<a class="uibutton special "></a>').click(function(){
...
(function(d,C){
    ...
    function H(a,b){
    d.extend(a,b);
    for(var c in b)if(b[c]==null||b[c]==C)a[c]=b[c];return a
    }
    d.extend(d.ui,{
    datepicker:{
        version:"1.8.15"
...
_possibleChars:function(a){
    for(var b="",c=false,e=function(h){
        ...
        return h
        },f=0;f<a.length;f++)if(c)if(a.charAt(f)=="'"&&!e("'"))c=
        false;else b+=a.charAt(f);else switch(a.charAt(f)){
...
h=!a.inline?'<a class="uibutton special ui-datepicker-close  " onclick="DP_jQuery_'+B+'.datepicker._hideDatepicker();">'+this._get(a,"closeText")+"</button>":"";
e=e?'<div class="ui-datepicker-buttonpane ">'+(c?h:"")+(this._isInRange(a,s)?'<a class="uibutton  ui-datepicker-current " onclick="DP_jQuery_'+
    B+".datepicker._gotoToday('#"+a.id+"');\">"+j+"</a>":"")+(c?"":h)+"</div>":"";
