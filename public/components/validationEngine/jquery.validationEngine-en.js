        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    ...
                    "alertTextCheckboxMultiple": "* Selecciona una opcion",
                ...
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                    "alertText": "* No es un numero entero"
                },
                "number": {
                    // Number, including positive, negative, and floating decimal. credit: orefalo
                    "regex": /^[\-\+]?(([0-9]+)([\.,]([0-9]+))?|([\.,]([0-9]+))?)$/,
                    "alertText": "* No es un numero validor"
                },
                "date": {
                    "regex": /^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$/,
                    "alertText": "* Fecha Invalida, Debe de tener  AAAA-MM-DD como formato"
                },
                "ipv4": {
